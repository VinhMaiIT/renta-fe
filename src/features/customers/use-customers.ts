...
export function useCreateCustomer() {
  ...
  return useMutation({
    ...
    onError: (error) => toastError(error, 'Could not create customer'),
  });
}
...
export function useUpdateCustomer() {
  ...
  return useMutation({
    ...
    onError: (error) => toastError(error, 'Could not update customer'),
  });
}
...
export function useDeleteCustomer() {
  ...
  return useMutation({
    ...
    onError: (error) => toastError(error, 'Could not delete customer'),
  });
}
