    ...
    <div className={cn('w-full', className)}>
      ...
      >
        ...
        <div
          ref={anchorRef}
          className={cn(
            'group/trigger dark:bg-input/30 border-input relative flex w-full rounded-md border bg-transparent shadow-xs transition-[border-color,box-shadow]',
                ...
                {(limitTags !== undefined
                  ...
                  return (
                    <Badge
                      key={id}
                      variant="outline"
                      className="border-border flex max-w-fit min-w-0 flex-1 items-center gap-1 rounded-sm pr-0.5 font-normal"
                    >
                      {onSelectedRender ? (
                      ...
                      {!requireApply && !disabled && (
                        <button
                          type="button"
                          className="text-muted-foreground hover:text-foreground pointer-events-auto z-10 me-1 inline-flex size-3.5 shrink-0 cursor-pointer items-center justify-center rounded"
            ...
            {externalValues.length > 0 && !disabled ? (
              showClearIcon && showArrowIcon ? (
                ...
                <button
                  type="button"
                  className={cn(
                    'text-muted-foreground hover:text-foreground flex cursor-pointer items-center justify-center rounded',
        ...
        <ComboboxContent anchor={anchorRef}>
                  ...
                  return (
                    ...
                    >
                      <ComboboxPrimitive.Item
                        value={option.id}
                        className={cn(
                          'relative mt-px flex w-full cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none',
                        ...
                        <Checkbox
                          ...
                          label={
                            <span className="flex w-full items-center">
                              ...
                              <Check
                                className={cn(
                                  'text-primary ml-auto h-4 w-4 shrink-0 transition-opacity',
          ...
          {requireApply && (
            <div className="border-border/70 flex items-center gap-2 border-t p-2">
